...
public class TGTableRowButtonsCell extends TGTableRowCell {
  ...
  private TGIconCheckButton visibleButton;
  ...
  public TGTableRowButtonsCell(final TGTableRow row) {
    ...
    this.visibleButton = new TGIconCheckButton(table.getUIFactory(), getControl());
    table.appendListeners(this.soloButton.getControl());
    table.appendListeners(this.muteButton.getControl());
    table.appendListeners(this.visibleButton.getControl());
    ...
    this.visibleButton.addSelectionListener(createClickListener(TGChangeTrackVisibleAction.NAME));
    ...
    getLayout().set(this.visibleButton.getControl(), 1, 3, UITableLayout.ALIGN_CENTER, UITableLayout.ALIGN_CENTER, false, false, 1, 1, null, null, 2f);
    loadProperties();
    loadIcons();
  }
  ...
  public void setBgColor(UIColor background) {
    ...
    this.visibleButton.getControl().setBgColor(background);
  }
  ...
  public void setFgColor(UIColor foreground) {
    ...
    this.visibleButton.getControl().setFgColor(foreground);
  }
  ...
  public void setMenu(UIPopupMenu menu) {
    ...
    this.visibleButton.getControl().setPopupMenu(menu);
  }
  ...
  public void addMouseDownListener(UIMouseDownListener listener) {
    ...
    this.visibleButton.getControl().addMouseDownListener(listener);
  }
  ...
  public void addMouseUpListener(UIMouseUpListener listener) {
    ...
    this.visibleButton.getControl().addMouseUpListener(listener);
  }
  ...
  public void setVisible(boolean visible) {
    this.visibleButton.setSelected(visible);
  }
  ...
  public void loadProperties() {
    ...
    this.visibleButton.getControl().setToolTipText(TuxGuitar.getProperty("track.visible"));
  }
