...
public class TGChangeLetRingAction extends TGActionBase {
	
	public static final String NAME = "action.note.effect.change-let-ring";
	
	public TGChangeLetRingAction(TGContext context) {
		super(context, NAME);
	}
	...
	protected void processAction(TGActionContext context){
		...
		for (TGNote note : noteRange.getNotes()) {
			getSongManager(context).getMeasureManager().changeLetRing(note);
		}
	}
}
